...
$infoDisc = $db->query(" SELECT articles.Article_id, articles.Article_Image, articles.Article_Nom, articles.Type_id, Article_Categorie ,type.Type_Nom,articles.Article_Prix  FROM `articles` JOIN `type` on articles.type_id = type.type_id and  type.type_id =2 ");

$infoDisc1 = $db->query(" SELECT articles.Article_id, articles.Article_Image, articles.Article_Nom, articles.Type_id, Article_Categorie ,type.Type_Nom,articles.Article_Prix  FROM `articles` JOIN `type` on articles.type_id = type.type_id and  type.type_id =2 ");
...
<body>
    ...
    <div class="text-focus-in">
        ...
        <div class="row text-center">
            ...
            <div class="col-12 ">
                ...
                <h2 class="display-5">Nos Cordes </h2>
            </div>
        </div>
    </div>
    <!-- fin de entete -->
    ...
    <div class="col-md-12 ">
        <h2 style="text-align: center;">Voici notre section d'instruments à cordes dans laquelle vous trouverez les
            instruments du quatuor en allant
            des Violons aux pianos jusqu'aux guitares avec des instruments à prix réduits mais qui conservent une
            qualité suffisante pour encourager les débutants et satisfaire les amateurs.</h2> <br> <br>
    </div>
            ...
            ?>
                <tr style="font-size: 1.5em">
                    <td class="align-middle" width="300px">
                        <img src="../filrouge/imagesFilRouge/<?= $info['Article_Image'] ?>" alt="Photo d'illustration" title="Photo de <?= $info->Article_Image ?>" class="pic" height="auto" width="180px"></td>
    ...
    <div class="containertel">
        <h1 class="text-center">Cordes</h1>
