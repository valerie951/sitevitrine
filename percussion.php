...
$infoDisc = $db->query(" SELECT articles.Article_id, articles.Article_Image, articles.Article_Nom, articles.Type_id, Article_Categorie ,type.Type_Nom,articles.Article_Prix  FROM `articles` JOIN `type` on articles.type_id = type.type_id and  type.type_id =1 ");

$infoDisc1 = $db->query(" SELECT articles.Article_id, articles.Article_Image, articles.Article_Nom, articles.Type_id, Article_Categorie ,type.Type_Nom,articles.Article_Prix  FROM `articles` JOIN `type` on articles.type_id = type.type_id and  type.type_id =1 ");
?>
...
<body>
    ...
    <div class="text-focus-in">
        ...
        <div class="row text-center">
            ...
            <div class="col-12 ">
                ...
                <h2 class="display-5">Nos percussions</h2>
            </div>
        </div>
    </div>
    <!-- fin de entete -->
    ...
    <div class="col-md-12 ">
        <h2 style="text-align: center;">Bienvenu dans la section Percussions du site Village Green dans laquelle vous
            allez pouvoir retrouver les grandes familles des instruments de percussion.

            Parcourez nos nombreuses catégories afin de faire découvrir ce monde de richesses sonores aux plus
            jeunes.</h2> <br>
        <br>
    </div>
    ...
    <div class="containertel">
        <h1 class="text-center">Percussions</h1>
