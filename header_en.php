...
<!DOCTYPE html>
<html lang="fr" onload="CacherLangues('nl','en');">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="../filrouge/villageGreen.php">Home <span class="sr-only">(current)</span></a>
            </li>
...
<!-- ajout article pour admin -->
    ...
    ?>
        <form action="" method="post">
<a href="../filrouge/ajout.php" class="">Ajouter un article</a>             
        </form>
    <?php
    } else { }
    ?>
